...
router.delete('/:id/phones/:number', validateIdParam, validatePhoneParam, clientsController.deletePhones); //tested
router.delete('/:id/phones', validateIdParam, clientsController.deleteAllPhones); //tested
